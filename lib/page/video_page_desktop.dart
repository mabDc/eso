...
//                                         profile.desktopPlayerParseUrl,
//                                         (s) =>
//                                             profile.desktopPlayerParseUrl = s,
//                                         true,
//                                       ),
//                                     ),
//                                   ),
...
//   String _parseUrl;
//   String get parseUrl => _parseUrl = profile.desktopPlayerParseUrl;
...
//         _url = content.first;
//         log("播放地址 $_url\n自动开始本地播放");
//         if (profile.desktopPlayerParseUrl.isNotEmpty) {
//           if (!webcontroller.value.isInitialized)
//             await webcontroller.initialize();
//           if (_url.startsWith("https")) {
//             // _url = "https://jx.parwix.com:4433/player/?url=" +
//             //     Uri.encodeFull(_url);
//             _url = profile.desktopPlayerParseUrl + Uri.encodeFull(_url);
//           } else {
//             var dir = kDebugMode
